    ...
    <main>
      <div className="main_container">
        <img
          src={Hero}
          className="hero"
          alt="Woman relaxing in the salt room"
        />
        ...
        <div>
          ...
          />
          <p>
            Halotherapy helps to draw the impurities out of the air-way, both
            upper and lower respiratory systems. It stimulates the body’s
            internal processes for cleansing and removing build-up of foreign
            particles. Halotherapy opens bronchial tubes in the lungs, reduces
            inflammation in the sinuses and strengthens respiratory function by
            clearing moisture and breaking up mucus.{" "}
          </p>
          ...
          <p className="testimony">
            I am always searching for the highest quality ingredients + products
            to continue fulfilling all of your Holistic esthetic needs. My goal
            is to help you{" "}
